...
namespace ff
{
    ...
    {
    public:
        using this_type = typename unordered_multimap<Key, T, Hash, KeyEqual>;
...
namespace std
{
    ...
    void swap(ff::unordered_multimap<Key, Hash, KeyEqual>& lhs, ff::unordered_multimap<Key, Hash, KeyEqual>& other) noexcept(noexcept(lhs.swap(other)))
    {
        lhs.swap(other);
    }
}
