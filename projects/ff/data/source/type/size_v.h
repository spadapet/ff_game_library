...
namespace ff::type
{
    ...
    class size_type : public ff::value_type_simple<ff::type::size_v>
    {
    public:
    ...
    using size_vector = ff::value_vector_base<size_t>;

    template<>
    struct value_traits<std::vector<size_t>> : public value_derived_traits<ff::type::size_vector>
    {};

    class size_vector_type : public ff::value_type_pod_vector<ff::type::size_vector>
    {
