...
namespace ff::type
{
    ...
    class int_type : public ff::value_type_simple<ff::type::int_v>
    {
    public:
    ...
    using int_vector = ff::value_vector_base<int>;

    template<>
    struct value_traits<std::vector<int>> : public value_derived_traits<ff::type::int_vector>
    {};

    class int_vector_type : public ff::value_type_pod_vector<ff::type::int_vector>
    {
