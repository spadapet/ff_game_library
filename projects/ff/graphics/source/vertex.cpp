...
const std::array<D3D11_INPUT_ELEMENT_DESC, 6>& ff::vertex::circle_geometry::layout()
{
...
const std::array<D3D11_INPUT_ELEMENT_DESC, 8>& ff::vertex::triangle_geometry::layout()
{
...
const std::array<D3D11_INPUT_ELEMENT_DESC, 8>& ff::vertex::sprite_geometry::layout()
{
    static const std::array<D3D11_INPUT_ELEMENT_DESC, 8> layout
    {
