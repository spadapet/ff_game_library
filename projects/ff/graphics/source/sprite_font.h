...
namespace ff
{
    ...
    public:
        ...
        virtual ff::point_float draw_text(ff::renderer_base* render, std::string_view text, const ff::transform& transform, const DirectX::XMFLOAT4& outline_color, ff::sprite_font_options options) const;
