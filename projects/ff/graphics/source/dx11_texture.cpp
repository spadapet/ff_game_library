...
ff::dx11_texture_o::dx11_texture_o(const std::filesystem::path& path, DXGI_FORMAT format, size_t mip_count)
{
}
...
ff::dx11_texture_o::dx11_texture_o(ff::point_int size, const std::shared_ptr<ff::palette_data>& palette, size_t array_size, size_t sample_count)
{
}

ff::dx11_texture_o::dx11_texture_o(DirectX::ScratchImage&& data)
{
}

ff::dx11_texture_o::dx11_texture_o(DirectX::ScratchImage&& data, const std::shared_ptr<ff::palette_data>& palette)
{
}

ff::dx11_texture_o::dx11_texture_o(const dx11_texture_o& texture, DXGI_FORMAT new_format, size_t new_mip_count)
{
}
...
std::shared_ptr<ff::palette_data> ff::dx11_texture_o::palette() const
{
    return std::shared_ptr<ff::palette_data>();
}
