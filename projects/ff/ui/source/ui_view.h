...
namespace ff
{
    ...
    public:
        ...
        virtual void render(ff::target_base& target, ff::dx11_depth& depth, const ff::rect_float* view_rect = nullptr);
    ...
    protected:
        virtual bool render_begin(ff::target_base& target, ff::dx11_depth& depth, const ff::rect_float* view_rect);
