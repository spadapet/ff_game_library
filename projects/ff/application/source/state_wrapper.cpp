...
void ff::state_wrapper::render(ff::target_base& target, ff::depth& depth)
{
    if (this->state)
    {
...
void ff::state_wrapper::frame_rendered(ff::state::advance_t type, ff::target_base& target, ff::depth& depth)
{
    if (this->state)
    {
