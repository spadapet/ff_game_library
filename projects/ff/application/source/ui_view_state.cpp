...
ff::ui_view_state::ui_view_state(std::shared_ptr<ff::ui_view> view, std::shared_ptr<ff::dx11_target_base> target_override, std::shared_ptr<ff::dx11_depth> depth_override)
    : view_(view)
