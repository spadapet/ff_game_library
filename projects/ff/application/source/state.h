...
namespace ff
{
    ...
    public:
        ...
        virtual void render(ff::target_base& target, ff::dx11_depth& depth);
        virtual void render();

        virtual void frame_started(ff::state::advance_t type);
        virtual void frame_rendering(ff::state::advance_t type);
        virtual void frame_rendered(ff::state::advance_t type, ff::target_base& target, ff::dx11_depth& depth);
