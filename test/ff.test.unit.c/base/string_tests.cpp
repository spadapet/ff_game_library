...
namespace ff::test::base
{
    ...
    public:
        ...
        TEST_METHOD(utf8_to_wide_ascii)
        {
            ...
            ff_wstring_view dest = ff_utf8_to_wide(src, &arena);
        ...
        TEST_METHOD(utf8_to_wide_from_sz_view)
        {
            ...
            ff_wstring_view dest = ff_utf8_to_wide(ff_sz_view("abc"), &arena);
        ...
        TEST_METHOD(wide_to_utf8_ascii)
        {
            ...
            ff_string_view dest = ff_wide_to_utf8(src, &arena);
        ...
        TEST_METHOD(wide_to_utf8_from_sz_view)
        {
            ...
            ff_string_view dest = ff_wide_to_utf8(ff_wz_view(L"abc"), &arena);
        ...
        TEST_METHOD(round_trip_utf8_wide_utf8)
        {
            ...
            ff_wstring_view wide = ff_utf8_to_wide(src, &arena);
            ff_string_view back = ff_wide_to_utf8(wide, &arena);
        ...
        TEST_METHOD(round_trip_wide_utf8_wide)
        {
            ...
            ff_string_view utf8 = ff_wide_to_utf8(src, &arena);
            ff_wstring_view back = ff_utf8_to_wide(utf8, &arena);
        ...
        TEST_METHOD(ff_wsvl_round_trips_through_utf8)
        {
            ...
            ff_string_view utf8 = ff_wide_to_utf8(FF_WSVL(L"Hello"), &arena);
