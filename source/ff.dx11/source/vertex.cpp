...
const std::array<D3D11_INPUT_ELEMENT_DESC, 10>& ff::dx11::vertex::line_geometry::layout()
{
...
const std::array<D3D11_INPUT_ELEMENT_DESC, 6>& ff::dx11::vertex::circle_geometry::layout()
{
...
const std::array<D3D11_INPUT_ELEMENT_DESC, 8>& ff::dx11::vertex::triangle_geometry::layout()
{
...
const std::array<D3D11_INPUT_ELEMENT_DESC, 8>& ff::dx11::vertex::sprite_geometry::layout()
{
    static const std::array<D3D11_INPUT_ELEMENT_DESC, 8> layout
    {
