...
std::shared_ptr<ff::dxgi::target_window_base> ff::dxgi::client_functions::create_target_for_window(ff::window* window) const
{
    return this->create_target_for_window_(window);
}
