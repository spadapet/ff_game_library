...
#include "texture_metadata_base.h"
...
namespace ff::dxgi
{
    ...
    public:
        ...
        virtual bool update(ff::dxgi::command_context_base& context, size_t array_index, size_t mip_index, const ff::point_int& pos, const DirectX::Image& data) = 0;
    };
}
