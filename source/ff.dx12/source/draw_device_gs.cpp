...
namespace
{
    ...
    class dx12_draw_device : public ff::internal::dx12::draw_device_base
    {
    public:
        dx12_draw_device()
            : states_
    ...
    protected:
        virtual void internal_destroy() override
        {
            ...
            ff::internal::dx12::draw_device_base::internal_destroy();
        }

        virtual void internal_reset() override
        {
            ff::internal::dx12::draw_device_base::internal_reset();
        ...
        {
            ff::dxgi::command_context_base& context2 = *ff::internal::dx12::draw_device_base::internal_setup(context, target, depth, view_rect, ignore_rotation);
            ff::dx12::commands& commands = ff::dx12::commands::get(context2);
            commands.root_signature(this->root_signature.Get());
            commands.root_descriptors(3, this->samplers_gpu);
...
std::unique_ptr<ff::dxgi::draw_device_base> ff::internal::dx12::create_draw_device_gs()
{
