...
namespace ff::dx12
{
    ...
    public:
        ...
        D3D12_DESCRIPTOR_HEAP_DESC set(ID3D12DescriptorHeapX* descriptor_heap);
    ...
    public:
        ...
        void set(ID3D12DescriptorHeapX* descriptor_heap);
    ...
    private:
        friend ID3D12DescriptorHeapX* ff::dx12::get_descriptor_heap(const ff::dx12::gpu_descriptor_allocator& obj);
