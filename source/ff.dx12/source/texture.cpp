...
ff::dx12::texture::texture(ff::point_int size, DXGI_FORMAT format, size_t mip_count, size_t array_size, size_t sample_count)
    : sprite_type_(ff::dxgi::sprite_type::unknown)
{
...
ff::point_int ff::dx12::texture::size() const
{
    if (this->data_)
    {
