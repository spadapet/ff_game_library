...
namespace
{
    struct device_child_t
    {
        ...
        ff::internal::dx12::device_child_base* child;
        ff::internal::dx12::device_reset_priority reset_priority;
        void* reset_data;
    };
}
...
static ff::signal<ff::internal::dx12::device_child_base*> removed_device_child;
...
bool ff::internal::dx12::init_globals(D3D_FEATURE_LEVEL feature_level)
{
...
void ff::internal::dx12::destroy_globals()
{
    ::destroy_d3d(false);
    ::destroy_dxgi();
}

void ff::internal::dx12::add_device_child(ff::internal::dx12::device_child_base* child, ff::internal::dx12::device_reset_priority reset_priority)
{
    std::scoped_lock lock(::device_children_mutex);
    ::device_children.push_back(::device_child_t{ child, reset_priority, nullptr });
}

void ff::internal::dx12::remove_device_child(ff::internal::dx12::device_child_base* child)
{
    std::scoped_lock lock(::device_children_mutex);
...
bool ff::dx12::reset(bool force)
{
    ...
    if (force)
    {
        ...
        else
        {
            ...
            ff::signal_connection connection = ::removed_device_child.connect([&sorted_children](ff::internal::dx12::device_child_base* child)
                {
