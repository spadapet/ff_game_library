...
ff::dxgi::matrix_stack::matrix_stack()
    : stack{ ff::dxgi::matrix_identity_4x4() }
{}
...
void ff::dxgi::matrix_stack::reset(const DirectX::XMFLOAT4X4* default_matrix)
{
    this->stack.resize(1);
...
void ff::dxgi::matrix_stack::set(const DirectX::XMFLOAT4X4& matrix)
{
...
void ff::dxgi::matrix_stack::transform(const DirectX::XMFLOAT4X4& matrix)
{
    if (matrix != ff::dxgi::matrix_identity_4x4())
    {
        this->matrix_changing_.notify(*this);
...
ff::signal_sink<const ff::dxgi::matrix_stack&>& ff::dxgi::matrix_stack::matrix_changing()
{
    return this->matrix_changing_;
}

ff::signal_sink<const ff::dxgi::matrix_stack&>& ff::dxgi::matrix_stack::matrix_changed()
{
