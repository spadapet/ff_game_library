...
const DirectX::XMFLOAT4& ff::dxgi::color_none()
{
    return ::color_none;
}

const DirectX::XMFLOAT4& ff::dxgi::color_white()
{
    return ::color_white;
}

const DirectX::XMFLOAT4& ff::dxgi::color_black()
{
    return ::color_black;
}

const DirectX::XMFLOAT4& ff::dxgi::color_red()
{
    return ::color_red;
}

const DirectX::XMFLOAT4& ff::dxgi::color_green()
{
    return ::color_green;
}

const DirectX::XMFLOAT4& ff::dxgi::color_blue()
{
    return ::color_blue;
}

const DirectX::XMFLOAT4& ff::dxgi::color_yellow()
{
    return ::color_yellow;
}

const DirectX::XMFLOAT4& ff::dxgi::color_cyan()
{
    return ::color_cyan;
}

const DirectX::XMFLOAT4& ff::dxgi::color_magenta()
{
...
void ff::dxgi::palette_index_to_color(const int* index, DirectX::XMFLOAT4* color, size_t count, float alpha)
{
    ...
    {
        ff::dxgi::palette_index_to_color(*index, *color, alpha);
    }
}
