...
namespace ff
{
    ...
    {
        transform();
        transform(ff::point_float position, ff::point_float scale = ff::point_float(1, 1), float rotation = 0.0f, const DirectX::XMFLOAT4& color = ff::color_white());
    ...
    {
        pixel_transform();
        pixel_transform(ff::point_fixed position, ff::point_fixed scale = ff::point_fixed(1, 1), ff::fixed_int rotation = 0, const DirectX::XMFLOAT4& color = ff::color_white());
