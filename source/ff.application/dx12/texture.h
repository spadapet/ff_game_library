...
namespace ff::dx12
{
    ...
    {
    public:
        texture(ff::point_size size, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, size_t mip_count = 1, size_t array_size = 1, size_t sample_count = 1, const ff::color* optimized_clear_color = nullptr);
