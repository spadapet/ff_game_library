...
void ff::sprite::draw_frame(ff::dxgi::draw_base& draw, const ff::transform& transform, float frame, const ff::dict* params)
{
    this->draw_animation(draw, transform);
}

void ff::sprite::draw_animation(ff::dxgi::draw_base& draw, const ff::transform& transform) const
{
