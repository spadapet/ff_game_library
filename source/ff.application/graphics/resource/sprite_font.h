...
namespace ff
{
    ...
    private:
        bool init_sprites();
        ff::point_float internal_draw_text(ff::dxgi::draw_base* draw, const ff::sprite_list* sprites, std::wstring_view text, const ff::transform& transform, ff::sprite_font_options options) const;
