...
#include "../resource/animation_keys.h"
...
namespace ff
{
    ...
    {
    public:
        create_animation(float length, float frames_per_second = ff::constants::updates_per_second<float>(), ff::animation_keys::method_t method = ff::animation_keys::method_t::default_);
