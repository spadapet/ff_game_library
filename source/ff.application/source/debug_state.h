...
namespace ff
{
    ...
    private:
        void update_stats();
        void render_text(ff::dxgi::target_base& target, ff::dxgi::depth_base& depth);
        void render_charts(ff::dxgi::target_base& target);
        ...
        std::unique_ptr<ff_dx::draw_device> draw_device;
