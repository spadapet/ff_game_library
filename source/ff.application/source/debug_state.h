...
namespace ff
{
    ...
    private:
        void update_stats();
        void render_text(ff::dxgi::command_context_base& context, ff::dxgi::target_base& target, ff::dxgi::depth_base& depth);
        void render_charts(ff::dxgi::command_context_base& context, ff::dxgi::target_base& target);
