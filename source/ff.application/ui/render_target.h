...
namespace ff::internal::ui
{
    ...
    public:
        ...
        const std::shared_ptr<ff::dxgi::target_base>& resolved_target() const;
        const std::shared_ptr<ff::dxgi::target_base>& msaa_target() const;
    ...
    private:
        ...
        std::shared_ptr<ff::dxgi::target_base> resolved_target_;
        std::shared_ptr<ff::dxgi::target_base> msaa_target_;
